...
const FreelancingCourses = ({ navigation }) => {
  ...
  const getUserData = async () => {
    try {
      ...
      const freelancing = realData.filter(
        (item) => item.category_name === "Freelancing"
      );
  ...
  return (
    <View style={styles.mainContainer}>
      <Text style={styles.mainHeader}>Freelancing Courses</Text>
      <FlatList
...
export default FreelancingCourses;
